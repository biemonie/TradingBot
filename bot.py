...
def build_email(signals, news_events):
    ...
    if not signals:
        ...
        for s in signals:
            ...
            # Fib table
            fib_rows = "".join([
                f"<tr><td style='padding:4px 8px;color:#8b949e;'>{n}</td>"
                f"<td style='padding:4px 8px;{\"color:#ffd700;font-weight:bold;\" if \"61.8\" in n else \"color:#e6edf3;\"}'>{l}</td></tr>"
...
def run_bot():
    print("=" * 60)
    print("  🤖 TRADING BOT — Quality Edition")
